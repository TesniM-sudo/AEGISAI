...
const CryptoCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className={`glass-card premium-border ${glowClass} relative min-h-[420px] w-full rounded-[32px] border border-black/10 p-5 text-left transition-all hover:border-black/30 dark:border-white/10 dark:hover:border-white/30 sm:p-7 shadow-xl group-hover:shadow-[0_20px_50px_-20px_rgba(0,0,0,0.5)] ${changePositive ? "hover:profit-flash" : ""}`}>
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-black/10 shadow-lg dark:border-white/10" style={{ background: `linear-gradient(135deg, ${color}33, ${color}11)` }}>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {sentiment && (
                    <span className="rounded-md bg-black/5 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-cyan-500 dark:bg-white/5 dark:text-cyan-400/80">
                      {sentiment}
                    </span>
                  )}
                </div>
            ...
            <div className="flex flex-col items-end gap-1.5">
              <span className="rounded-full border border-black/10 bg-black/5 px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider text-muted-foreground backdrop-blur-sm dark:border-white/10 dark:bg-white/5">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl bg-gradient-to-br from-black to-black/60 dark:from-white dark:to-white/60 bg-clip-text text-transparent">{price}</p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="rounded-2xl border border-black/10 bg-black/[0.03] p-4 transition-colors hover:bg-black/[0.06] dark:border-white/10 dark:bg-white/[0.03] dark:hover:bg-white/[0.06]">
            ...
            <div className="flex flex-col justify-between gap-6">
              <div className="rounded-[30px] border border-black/10 bg-black/5 p-4 drop-shadow-sm sm:p-5 dark:border-white/10 dark:bg-black/20 dark:shadow-inner">
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={onClick}
                className="group/btn flex items-center justify-between rounded-[28px] border border-black/10 bg-black/[0.04] p-5 transition-all hover:border-black/20 hover:bg-black/[0.08] active:scale-[0.98] dark:border-white/10 dark:bg-white/[0.04] dark:hover:border-white/20 dark:hover:bg-white/[0.08]"
              >
                <div>
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-black/5 transition-transform group-hover/btn:translate-x-1 dark:bg-white/5">
